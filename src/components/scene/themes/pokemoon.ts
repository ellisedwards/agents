...
export const pokemoonTheme: SceneTheme = {
  id: "pokemoon",
  name: "Pokemoon",
  ...
  // No background features — flat lunar horizon
  backgroundFeatures: [],
  ...
  monolithEffect: { style: "haze", color: "#8888cc", speed: 8 },

  // Pallet town sprites + pokeballs
  skins: {
    agent: "starter",
    openclaw: "trainer",
    subagent: "pikachu",
